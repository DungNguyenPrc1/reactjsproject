...
function EditClients() {
    ...
    const handleUpdate = async (e) => {
        ...
        let item = { company, email, phone };
        let newItems = { ...item, clientName: company, supportEmail: email, supportPhone: phone };

        const update = await axios.patch(`/admin/clients/${id}`, newItems, {
            headers: {
    ...
    return (
        <div>
            <div className="flex align-center h-10 ">
                ...
                <span className="uppercase text-primary font-bold">Edit Client</span>
            </div>
